  ...
  const packages = [
    {
      ...
      coverage: "2 Days Shoot",
      included: [
        "• All Soft Copy Photos",
        "• 10 Edited Premium Photos",
        "• \"10 Days To Go\" Creative Photo Series"
      ],
      popular: false,
      bgColor: "bg-white"
    },
    {
      ...
      included: [
        "• All Soft Copy Photos",
        "• 15 Edited Premium Photos",
        "• \"15 Days To Go\" Creative Photo Series",
        "• 1 Cinematic Pre-Wedding Song",
        "• 2 Instagram Reels",
        "• Drone Coverage"
      ],
      popular: true,
  ...
  return (
    <div className="min-h-screen bg-light-gray py-16">
      <SEO 
        ...
        description="Premium pre-wedding photography and cinematic film packages by The Flash Photofilms."
      />
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="mt-6 text-xl text-medium-gray max-w-3xl mx-auto">
            Capture your love story before the wedding with cinematic pre-wedding photography and films by The Flash Photofilms. Choose from our carefully crafted packages or contact us for a customised quote.
          </p>
        </div>
