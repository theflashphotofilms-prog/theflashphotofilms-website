            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li className="flex items-start">
                  ...
                  <span className="text-medium-gray">Personalized photo album (Signature)</span>
                </li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-2">
                <li className="flex items-start">
                  ...
                  <span className="text-medium-gray">Additional hours (+₹3,000/hour)</span>
                </li>
                <li className="flex items-start">
                  <svg className="w-5 h-5 text-gold mr-2 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                  <span className="text-medium-gray">Physical photo album (+₹6,000)</span>
                </li>
                <li className="flex items-start">
                  <svg className="w-5 h-5 text-gold mr-2 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                  <span className="text-medium-gray">Additional photographer (+₹10,000)</span>
                </li>
                <li className="flex items-start">
                  <svg className="w-5 h-5 text-gold mr-2 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                  <span className="text-medium-gray">Video coverage (+₹20,000)</span>
                </li>
              </ul>
            </div>
          </div>
