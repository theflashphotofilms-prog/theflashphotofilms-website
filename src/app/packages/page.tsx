...
const PackagesPage = () => {
  ...
  const packages = [
    ...
    },
    {
      ...
      included: [
        ...
        "• 200 Photos Digital Frame",
        "• 200 Photos Canvas Print",
        "• Live Singing Performance (Upto 2 Hours)"
      ],
      popular: false,
      bgColor: "bg-white"
    }
  ...
  const handleBookNow = (packageName: string) => {
    ...
    if (typeof window !== 'undefined' && (window as any).gtag) {
      (window as any).gtag('event', 'click_wedding_package_cta', {
        package_name: packageName,
        page_title: 'Wedding Packages'
      });
    }
  };
  ...
  return (
    <div className="min-h-screen bg-light-gray py-16">
      <SEO 
        ...
        description="Premium wedding photography packages by The Flash Photofilms including traditional and candid photography, cinematic videography, albums, reels, highlights and drone coverage."
      />
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="mt-6 text-xl text-medium-gray max-w-3xl mx-auto">
            Choose from our premium wedding packages designed to capture every precious moment of your special day with artistic excellence and professional quality.
          </p>
        </div>
