...
export default function PreWeddingPortfolioPage() {
  const portfolioItems = [
    { id: 1, title: "Couple's Photoshoot", subtitle: "Udaipur", caption: "Love story moments", image: "/images/portfolio/prewedding-1.jpg", category: "prewedding" },
    { id: 2, title: "Romantic Shoot", subtitle: "Rajkot", caption: "Intimate celebration", image: "/images/portfolio/prewedding-2.jpg", category: "prewedding" },
    { id: 3, title: "Nature Romance", subtitle: "Mount Abu", caption: "Outdoor romance", image: "/images/portfolio/prewedding-3.jpg", category: "prewedding" },
    { id: 4, title: "Urban Love", subtitle: "Ahmedabad", caption: "City backdrop", image: "/images/portfolio/prewedding-4.jpg", category: "prewedding" },
    { id: 5, title: "Sunset Romance", subtitle: "Gandhinagar", caption: "Golden hour magic", image: "/images/portfolio/prewedding-5.jpg", category: "prewedding" },
    { id: 6, title: "Garden Romance", subtitle: "Vadodara", caption: "Floral beauty", image: "/images/portfolio/prewedding-6.jpg", category: "prewedding" },
  ];
      ...
      <div className="relative py-28">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-soft-gold max-w-3xl mx-auto">
            Romantic pre-wedding moments captured with timeless artistry
          </p>
        </div>
      </div>
