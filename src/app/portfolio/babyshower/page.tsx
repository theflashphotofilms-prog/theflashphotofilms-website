...
export default function BabyShowerPortfolioPage() {
  const portfolioItems = [
    { id: 1, title: "Baby Shower Joy", subtitle: "Ahmedabad", caption: "Delightful celebration", image: "/images/portfolio/babyshower-1.jpg", category: "babyshower" },
    { id: 2, title: "Blessing Celebration", subtitle: "Mumbai", caption: "Family gathering", image: "/images/portfolio/babyshower-2.jpg", category: "babyshower" },
    { id: 3, title: "Floral Theme", subtitle: "Surat", caption: "Beautiful decorations", image: "/images/portfolio/babyshower-3.jpg", category: "babyshower" },
    { id: 4, title: "Pastel Decor", subtitle: "Vadodara", caption: "Soft and elegant", image: "/images/portfolio/babyshower-4.jpg", category: "babyshower" },
    { id: 5, title: "Family Moments", subtitle: "Rajkot", caption: "Precious memories", image: "/images/portfolio/babyshower-5.jpg", category: "babyshower" },
    { id: 6, title: "Theme Party", subtitle: "Gandhinagar", caption: "Creative setup", image: "/images/portfolio/babyshower-6.jpg", category: "babyshower" },
  ];
      ...
      <div className="relative py-28">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-soft-gold max-w-3xl mx-auto">
            Delightful baby shower moments captured with timeless artistry
          </p>
        </div>
      </div>
