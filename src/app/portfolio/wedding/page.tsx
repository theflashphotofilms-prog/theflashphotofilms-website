...
export default function WeddingPortfolioPage() {
  const portfolioItems = [
    ...
    { id: 5, title: "Royal Wedding", subtitle: "Jaipur", caption: "Grand celebration", image: "/images/portfolio/wedding-5.jpg", category: "wedding" },
    { id: 6, title: "Intimate Wedding", subtitle: "Mumbai", caption: "Personal celebration", image: "/images/portfolio/wedding-6.jpg", category: "wedding" },
  ];
      ...
      <div className="relative py-28">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-soft-gold max-w-3xl mx-auto">
            Elegant wedding celebrations captured with timeless artistry
          </p>
        </div>
      </div>
