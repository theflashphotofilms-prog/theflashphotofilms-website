      ...
      <div className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-dark-maroon">Client Testimonials</h2>
            ...
            {testimonials.map((testimonial) => (
              ...
              >
                <div className="flex items-center mb-4">
                  ...
                  <div className="ml-4">
                    <h4 className="font-bold text-dark-maroon">{testimonial.name}</h4>
                ...
                <p className="text-medium-gray italic">&quot;{testimonial.feedback}&quot;</p>
