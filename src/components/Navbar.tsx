      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="hidden md:flex items-center space-x-4 lg:space-x-6">
            ...
            <Link 
              href="/packages" 
              className={`font-medium transition-colors hover:text-[#D2A97F] ${pathname === '/packages' ? 'text-[#D2A97F]' : scrolled ? 'text-[#D2A97F]' : 'text-[#3A5A40]'}`}
              onClick={closeMobileMenu}
            >
              Wedding Packages
            </Link>
            <Link 
              ...
              className={`font-medium transition-colors hover:text-[#D2A97F] ${pathname === '/pre-wedding-packages' ? 'text-[#D2A97F]' : scrolled ? 'text-[#D2A97F]' : 'text-[#3A5A40]'}`}
              onClick={closeMobileMenu}
            >
            ...
            <Link 
              ...
              className={`font-medium transition-colors hover:text-[#D2A97F] ${pathname === '/engagement-babyshower-packages' ? 'text-[#D2A97F]' : scrolled ? 'text-[#D2A97F]' : 'text-[#3A5A40]'}`}
              onClick={closeMobileMenu}
            >
            ...
            <Link 
              href="/portfolio" 
              className={`font-medium transition-colors hover:text-[#D2A97F] ${pathname === '/portfolio' ? 'text-[#D2A97F]' : scrolled ? 'text-[#D2A97F]' : 'text-[#3A5A40]'}`}
              onClick={closeMobileMenu}
            >
              Portfolio
            </Link>
            <Link 
              href="/feedback" 
              className={`font-medium transition-colors hover:text-[#D2A97F] ${pathname === '/feedback' ? 'text-[#D2A97F]' : scrolled ? 'text-[#D2A97F]' : 'text-[#3A5A40]'}`}
              onClick={closeMobileMenu}
            >
              Reviews
            </Link>
            <Link 
              href="/faq" 
              className={`font-medium transition-colors hover:text-[#D2A97F] ${pathname === '/faq' ? 'text-[#D2A97F]' : scrolled ? 'text-[#D2A97F]' : 'text-[#3A5A40]'}`}
              onClick={closeMobileMenu}
            >
              FAQ
            </Link>
            <Link 
              href="/contact" 
              className={`font-medium transition-colors hover:text-[#D2A97F] ${pathname === '/contact' ? 'text-[#D2A97F]' : scrolled ? 'text-[#D2A97F]' : 'text-[#3A5A40]'}`}
              onClick={closeMobileMenu}
            >
              Contact
            </Link>
            <Link 
              href="/disclaimer" 
              className={`font-medium transition-colors hover:text-[#D2A97F] ${pathname === '/disclaimer' ? 'text-[#D2A97F]' : scrolled ? 'text-[#D2A97F]' : 'text-[#3A5A40]'}`}
              onClick={closeMobileMenu}
            >
              Disclaimer
            </Link>
            <Link 
              href="/other-services" 
              className={`font-medium transition-colors hover:text-[#D2A97F] ${pathname === '/other-services' ? 'text-[#D2A97F]' : scrolled ? 'text-[#D2A97F]' : 'text-[#3A5A40]'}`}
              onClick={closeMobileMenu}
            >
              Other Services
            </Link>
            ...
            <Link 
              href="/contact" 
              className={`hidden lg:flex items-center bg-[#D2A97F] text-[#3A5A40] px-6 py-2 rounded-lg font-bold hover:bg-white hover:text-[#3A5A40] transition-colors ${scrolled ? 'bg-[#D2A97F] text-[#3A5A40]' : ''}`}
              onClick={closeMobileMenu}
            >
              Book Now
            </Link>
          ...
          <div className="flex items-center md:hidden">
            ...
            <button
              onClick={toggleMenu}
              className={`p-2 rounded-md ${scrolled ? 'text-[#D2A97F]' : 'text-[#3A5A40]'}`}
      ...
      {isMenuOpen && (
        <div className="md:hidden bg-[#3A5A40] dark:bg-[#3A5A40] shadow-lg rounded-lg mt-2 py-4 absolute left-0 right-0 mx-4 z-40 max-h-[calc(100vh-80px)] overflow-y-auto">
          <div className="flex flex-col space-y-4 px-4">
            ...
            <Link 
              href="/contact" 
              className="font-medium py-2 px-4 rounded bg-[#D2A97F] text-[#3A5A40] text-center hover:bg-white hover:text-[#3A5A40] transition-colors"
              onClick={closeMobileMenu}
            >
              Book Now
            </Link>
