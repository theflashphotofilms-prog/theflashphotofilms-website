const WhatsAppCTA = () => {
  // Using a placeholder WhatsApp number that can be replaced later
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-40 bg-green-500 text-white p-4 rounded-full shadow-lg hover:bg-green-600 transition-all duration-300 transform hover:scale-110 flex items-center justify-center"
